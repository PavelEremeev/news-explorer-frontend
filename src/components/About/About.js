    ...
    return (
        <section className="about">
            ...
            <div className="about__text-container">
                ...
                серьезно, то&nbsp;я&nbsp;пришел сюда из&nbsp;мира строительства, где все очень <b>(очень)</b>
                 аналоговое и&nbsp;архаичное, хочется сделать строительство
                &mdash;&nbsp;цифровым и&nbsp;удобным в&nbsp;работе для проектировщиков и&nbsp; сдаче
                объектов для строителей.</p>
            </div>
        </section>
    );
}
